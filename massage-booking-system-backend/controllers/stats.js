...
statsRouter.get('/', async (req, res, next) => {
    ...
    let unusedPastAppointments = pastAppointments.filter(appointment => appointment.type_of_reservation === 0)
    ...
    let totalAppointmentsUsed = numberOfUsersAppointments.reduce((accumulator, currentvalue) => accumulator + currentvalue) 
