...
describe('with any date given', () => {
  ...
  it('setDay finds the correct day from the date (representing the week) given', async () => {
    expect(new Date(timer.setDay(1, new Date(saturday))).toISOString()).toBe(
      '2019-07-15T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(2, new Date(saturday))).toISOString()).toBe(
      '2019-07-16T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(3, new Date(saturday))).toISOString()).toBe(
      '2019-07-17T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(4, new Date(saturday))).toISOString()).toBe(
      '2019-07-18T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(5, new Date(saturday))).toISOString()).toBe(
      '2019-07-19T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(6, new Date(saturday))).toISOString()).toBe(
      '2019-07-20T08:55:00.000Z'
    )
    expect(new Date(timer.setDay(7, new Date(saturday))).toISOString()).toBe(
      '2019-07-21T08:55:00.000Z'
    )
  })
